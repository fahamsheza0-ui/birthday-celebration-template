    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Safura!</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Safura's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message"> Keep shining!</h2>
          <p className="final-subtitle">enjoy your day✨</p>
        </section>
      </div>
